...
from adzerk_decision_sdk.exceptions import ApiTypeError, ApiValueError, ApiException
from adzerk_decision_sdk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DecisionApi()
        api_instance.get_decisions  # this is an instance of the class Endpoint
        api_instance.get_decisions()  # this invokes api_instance.get_decisions.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_decisions.callable or self.callable in this class
