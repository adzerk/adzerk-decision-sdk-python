...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of adzerk_decision_sdk.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = adzerk_decision_sdk.Configuration(
    ...
    Note you can use the constants defined in the adzerk_decision_sdk.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = adzerk_decision_sdk.Configuration(
        signing_info = adzerk_decision_sdk.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://e-23.adzerk.net",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("adzerk_decision_sdk")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'X-Adzerk-ApiKey' in self.api_key:
            auth['ApiKeyAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-Adzerk-ApiKey',
                'value': self.get_api_key_with_prefix('X-Adzerk-ApiKey')
            }
        return auth
